    ...
    <div className="nav_bar fixed left-0 top-0 h-full">
      <div className="h-full w-16 bg-black text-white flex flex-col justify-between py-4 z-[10000]">
        <div className="flex flex-col items-center">
          ...
          <div className="text-vertical mb-4">ASHISH NALLANA</div>
        </div>
        <div className="flex flex-col items-center space-y-4">
          <a
            href="https://www.linkedin.com/in/ashish-nallana-52a6651bb/"
            target="_blank"
            className="text-vertical"
          >
            LINKEDIN
          </a>
          <a href="https://x.com/AshishNallana" className="text-vertical">
            TWITTER
          </a>
          <a
