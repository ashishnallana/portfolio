  ...
  return (
    <div id="about_section" className="p-5 flex flex-col items-center w-[75vw]">
      ...
      <img
        src={myImg}
        alt="ashish nallana"
        className="w-[230px] h-[230px] rounded-full mb-10"
      />
      <p data-aos="fade-right">
        Hello! I'm Ashish Nallana, a full-stack developer based in
      ...
      <p data-aos="fade-left">
        I'm currently pursuing a BTech in Information Technology at Gayatri
        Vidya Parishad College of Engineering. This journey has been both
